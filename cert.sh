...
#openssl x509 -req -days 365 -extfile https.config -extensions v3_req -in csr.pem -signkey key.pem -out ${CERT}.crt
#openssl pkcs12 -export -out ${CERT}.pfx -inkey key.pem -in ${CERT}.crt -password pass:ufo
