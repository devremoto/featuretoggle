...
gnome-terminal -- dotnet run --project src/Skoruba.IdentityServer4.Admin/Skoruba.IdentityServer4.Admin.csproj

gnome-terminal -- dotnet run --project src/Skoruba.IdentityServer4.STS.Identity/Skoruba.IdentityServer4.STS.Identity.csproj
