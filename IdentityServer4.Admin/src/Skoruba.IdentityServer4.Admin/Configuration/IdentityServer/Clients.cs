        ...
        public static IEnumerable<Client> GetAdminClient(IAdminConfiguration adminConfiguration)
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                        ...
                        RedirectUris = { "http://localhost:4200/callback", "http://localhost:4200/admin", "http://localhost:4300/callback", "http://localhost:4300/admin" },
                        FrontChannelLogoutUri = "http://localhost:4200/callback",
                        PostLogoutRedirectUris = { "http://localhost:4200/callback","http://localhost:4300/callback" },
